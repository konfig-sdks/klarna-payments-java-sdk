...
public class SessionRead {
  ...
  **/
   ...
   * @return the SessionRead instance itself
   */
  public SessionRead putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acquiringChannel, sessionRead.acquiringChannel) &&
        ...
        Objects.equals(this.additionalProperties, sessionRead.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SessionRead
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SessionRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        CustomerRead.validateJsonObject(jsonObj.getAsJsonObject("customer"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SessionRead>() {
           ...
           public SessionRead read(JsonReader in) throws IOException {
             ...
             SessionRead instance = thisAdapter.fromJsonTree(jsonObj);
