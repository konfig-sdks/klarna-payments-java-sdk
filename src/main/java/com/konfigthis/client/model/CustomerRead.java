...
public class CustomerRead {
  ...
  **/
   ...
   * @return the CustomerRead instance itself
   */
  public CustomerRead putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, customerRead.title) &&
        Objects.equals(this.dateOfBirth, customerRead.dateOfBirth) &&
        ...
        Objects.equals(this.additionalProperties, customerRead.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, dateOfBirth, gender, organizationEntityType, organizationRegistrationId, type, vatId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomerRead
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomerRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerRead>() {
           ...
           public CustomerRead read(JsonReader in) throws IOException {
             ...
             CustomerRead instance = thisAdapter.fromJsonTree(jsonObj);
