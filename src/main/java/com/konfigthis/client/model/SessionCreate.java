...
public class SessionCreate {
 ...
 public enum IntentEnum {
  ...
  public SessionCreate acquiringChannel(AcquiringChannelEnum acquiringChannel) {
  ...
  **/
  ...
  public SessionCreate attachment(Attachment attachment) {
  ...
  **/
  ...
  public SessionCreate billingAddress(Address billingAddress) {
  ...
  **/
  ...
  public SessionCreate customPaymentMethodIds(List<String> customPaymentMethodIds) {
  ...
  public SessionCreate addCustomPaymentMethodIdsItem(String customPaymentMethodIdsItem) {
  ...
  **/
  ...
  public SessionCreate customer(Customer customer) {
  ...
  **/
  ...
  public SessionCreate design(String design) {
  ...
  **/
  ...
  public SessionCreate locale(String locale) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "en-US", value = "Used to define the language and region of the customer. The locale follows the format of [RFC 1766](https://datatracker.ietf.org/doc/rfc1766/), meaning its value consists of language-country. Default value is \"en-US\". Read more on **[Supported Locals and Currencies](https://docs.klarna.com/klarna-payments/in-depth-knowledge/puchase-countries-currencies-locales/)**.")
  ...
  public SessionCreate merchantData(String merchantData) {
  ...
  **/
  ...
  public SessionCreate merchantReference1(String merchantReference1) {
  ...
  **/
  ...
  public SessionCreate merchantReference2(String merchantReference2) {
  ...
  **/
  ...
  public SessionCreate merchantUrls(MerchantUrls merchantUrls) {
  ...
  **/
  ...
  public SessionCreate options(Options options) {
  ...
  **/
  ...
  public SessionCreate orderAmount(Long orderAmount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2000", required = true, value = "Total amount of the order including tax and any available discounts. The value should be in non-negative minor units. Eg: 25 Euros should be 2500.")
  ...
  public SessionCreate orderLines(List<OrderLine> orderLines) {
  ...
  public SessionCreate addOrderLinesItem(OrderLine orderLinesItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The array containing list of line items that are part of this order. Maximum of 1000 line items could be processed in a single order.")
  ...
  public SessionCreate orderTaxAmount(Long orderTaxAmount) {
  ...
  **/
  ...
  public SessionCreate purchaseCountry(String purchaseCountry) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "GB", required = true, value = "The purchase country of the customer. The billing country always overrides purchase country if the values are different. Formatted according to ISO 3166 alpha-2 standard, e.g. GB, SE, DE, US, etc.")
  ...
  public SessionCreate purchaseCurrency(String purchaseCurrency) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "GBP", required = true, value = "The purchase currency of the order. Formatted according to ISO 4217 standard, e.g. USD, EUR, SEK, GBP, etc.")
  ...
  public SessionCreate shippingAddress(Address shippingAddress) {
  ...
  **/
  ...
  public SessionCreate intent(IntentEnum intent) {
  ...
  **/
   ...
   * @return the SessionCreate instance itself
   */
  public SessionCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acquiringChannel, sessionCreate.acquiringChannel) &&
        Objects.equals(this.attachment, sessionCreate.attachment) &&
        Objects.equals(this.authorizationToken, sessionCreate.authorizationToken) &&
        Objects.equals(this.billingAddress, sessionCreate.billingAddress) &&
        Objects.equals(this.clientToken, sessionCreate.clientToken) &&
        Objects.equals(this.customPaymentMethodIds, sessionCreate.customPaymentMethodIds) &&
        Objects.equals(this.customer, sessionCreate.customer) &&
        Objects.equals(this.design, sessionCreate.design) &&
        Objects.equals(this.expiresAt, sessionCreate.expiresAt) &&
        Objects.equals(this.locale, sessionCreate.locale) &&
        Objects.equals(this.merchantData, sessionCreate.merchantData) &&
        Objects.equals(this.merchantReference1, sessionCreate.merchantReference1) &&
        Objects.equals(this.merchantReference2, sessionCreate.merchantReference2) &&
        Objects.equals(this.merchantUrls, sessionCreate.merchantUrls) &&
        Objects.equals(this.options, sessionCreate.options) &&
        Objects.equals(this.orderAmount, sessionCreate.orderAmount) &&
        Objects.equals(this.orderLines, sessionCreate.orderLines) &&
        Objects.equals(this.orderTaxAmount, sessionCreate.orderTaxAmount) &&
        Objects.equals(this.paymentMethodCategories, sessionCreate.paymentMethodCategories) &&
        Objects.equals(this.purchaseCountry, sessionCreate.purchaseCountry) &&
        Objects.equals(this.purchaseCurrency, sessionCreate.purchaseCurrency) &&
        Objects.equals(this.shippingAddress, sessionCreate.shippingAddress) &&
        Objects.equals(this.status, sessionCreate.status) &&
        Objects.equals(this.intent, sessionCreate.intent)&&
        Objects.equals(this.additionalProperties, sessionCreate.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SessionCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SessionCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionCreate is not found in the empty JSON string", SessionCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SessionCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionCreate>() {
           @Override
           public void write(JsonWriter out, SessionCreate value) throws IOException {
           ...
           @Override
           public SessionCreate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SessionCreate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SessionCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionCreate
  * @throws IOException if the JSON string is invalid with respect to SessionCreate
  */
  public static SessionCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionCreate.class);
  }

 /**
  * Convert an instance of SessionCreate to an JSON string
  *
  * @return JSON string
  */
