...
public class CreateOrderRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Allow merchant to trigger auto capturing.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizationToken, autoCapture, billingAddress, customPaymentMethodIds, customer, locale, merchantData, merchantReference1, merchantReference2, merchantUrls, orderAmount, orderLines, orderTaxAmount, paymentMethodCategories, purchaseCountry, purchaseCurrency, shippingAddress, status, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateOrderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateOrderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
